...
export const selectLoadingGamesError = createSelector(
    selectGameState,
    (state: GameState) => state.loadingGamesError
);
...
export const selectLoadingGameError = createSelector(
    selectGameState,
    (state: GameState) => state.loadingGameError
);
