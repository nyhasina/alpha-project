...
export const loadTagsAutocompletion = createAction('[Team] Load tags autocompletion', props<{ criteria?: Criteria<Tag> }>());
export const loadTagsAutocompletionFail = createAction(
    '[Team] Load tags autocompletion fail',
